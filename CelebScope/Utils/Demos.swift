...
class Demos {
    public static let demos: [Demo] = {
        ...
        let person2_0 = Person(id: 0, name: "Movie Star Maggie", avartar: UIImage(imageLiteralResourceName: "demo2_avartar_0"), birthDate: "1970", deathDate: "2016", birthPlace: "Neverland", imdbId: "nm0000333", bio: "A very famous male movie producer", profession: "Actress, Writer, Producer")
